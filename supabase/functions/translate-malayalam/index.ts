    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a translator. Translate the following English text to Malayalam. Return ONLY the Malayalam translation, nothing else. Keep proper nouns, names, room numbers, and phone numbers as-is."
          },
